...
/**
 * Validation boundary for the create/edit event form (task 2.2a, core fields).
 *
 ...
 * checkboxes → boolean, numerics → int. The 🟡 placeholder columns (lat/lng,
 * photo upload, approval, anonymise, theme/effect/chip_in) are deliberately NOT
 * touched here — they keep their DB defaults until their own tasks.
 */
